...
var (
	pattern_Greeter_SayHello_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"greeter", "name"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Greeter_SayHelloAgain_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"greeter"}, "", runtime.AssumeColonVerbOpt(true)))
)
